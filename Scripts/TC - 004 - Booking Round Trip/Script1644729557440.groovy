...
WebUI.click(findTestObject('Page_Search Hotels - PHPTRAVELS/input_round_trip'))

WebUI.setText(findTestObject('Object Repository/Page_Search Hotels - PHPTRAVELS/input_Flying From_from'), Flying)
...
WebUI.setText(findTestObject('Page_Search Hotels - PHPTRAVELS/input_Return Date_returning'), Return)
